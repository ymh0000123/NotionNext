...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://feishu.xiao-feishu.top', // 网站地址
  ...
  TianliGPT_JS:
    ...
    'https://resource-files.xiao-feishu.top/js/ai-summary.js',
  TianliGPT_KEY: process.env.NEXT_PUBLIC_TIANLI_GPT_KEY || '6owaw57iyxndxv5rftc2g4ao6xo67tea',
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9181643453', // 对应歌单的 id
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://unpkg.com/twikoo@1.6.38/dist/twikoo.all.min.js', // twikoo客户端cdn
