...
const BLOG = {
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://resource-files.xiao-feishu.top/js/xn.js','https://resource-files.xiao-feishu.top/js/domainCheck.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
